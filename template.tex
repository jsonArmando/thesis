...
\title[DISEÑO Y SIMULACIÓN DE SOLUCIÓN SD-WAN PARA UN CLIENTE RETAIL\\CON CONSUMO DE SERVICICIOS EN LA NUBE]{A Very Long and Impressive Thesis Title With a Line Break}
...
% use [f] for female and [m] for male
\adviser[f]{Joan Sebastian Quintero Ceballos}{Ingeniero en Telecomunicaciones}{\\& NOVA University of Lisbon} 
...
% use [f] for female and [m] for male
\coadviser[f]{José Armando Son Rojas}{Ingeniero\\& Electrónico}{NOVA University of Lisbon}
