...
\title[DISEÑO Y SIMULACIÓN DE SOLUCIÓN SD-WAN PARA UN CLIENTE RETAIL\\CON CONSUMO DE SERVICIOS EN LA NUBE]{Diseño y Simulación de Solución SD-WAN para un Cliente}
...
% use [f] for female and [m] for male
\adviser[f]{\textbf{Joan Sebastian Quintero Ceballos}}{Ingeniero en Telecomunicaciones}{\\& jquintero@unbosque.edu.co} 
...
% use [f] for female and [m] for male
\coadviser[f]{\textbf{José Armando Son Rojas}}{Ingeniero\\& Electrónico}{json@unbosque.edu.co}
...
\addlisttofrontmatter{\listoftables{tablas}}   % The List of Tables. Comment to omit.
